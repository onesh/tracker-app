...
class AuthForm extends Component {
  ...
  constructor(props) {
    ...
    if (props.formFields.indexOf('DeviceId') > -1) formFields.DeviceId = FormValidation.String;
    if (props.formFields.indexOf('DeviceName') > -1) formFields.DeviceName = FormValidation.String;
    ...
    this.state = {
      ...
      options: {
        fields: {
          ...
          DeviceId: {
            template: TcombTextInput,
            error: 'Please enter your device id',
            clearButtonMode: 'while-editing',
          },
          DeviceName: {
            template: TcombTextInput,
            error: 'Please enter your device name',
            clearButtonMode: 'while-editing',
          },
        },
      },
